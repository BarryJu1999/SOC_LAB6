# 0 "counter_la_all.c"
# 1 "/home/ubuntu/lab-wlos_baseline/testbench/wrapper_all//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la_all.c"
# 19 "counter_la_all.c"
...
# 20 "counter_la_all.c" 2

# 1 "../../firmware/user_uart.h" 1
# 22 "counter_la_all.c" 2
...
# 147 "counter_la_all.c"
 int* task;
 task = matmul();


 (*(volatile uint32_t*)0x2600000c) = *task << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task+3) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task+9) << 16;
 ...
 (*(volatile uint32_t*)0x2600000c) = *(task+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task+3) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task+4) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task+5) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task+6) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task+7) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task+8) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task+9) << 16;
 ...
 (*(volatile uint32_t*)0x2600000c) = *(task+8) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task+9) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task+10) << 16;

 (*(volatile uint32_t*)0x2600000c) = 0xAB530000;

 (*(volatile uint32_t*)0x2600000c) = 0xAB430000;
 (*(volatile uint32_t*)0x2600000c) = 0xAB540000;
