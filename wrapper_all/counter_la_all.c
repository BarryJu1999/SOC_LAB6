...
*/	
	...
	reg_mprj_datal = *task << 16;
	reg_mprj_datal = *(task+1) << 16;
	reg_mprj_datal = *(task+2) << 16;
	reg_mprj_datal = *(task+3) << 16;
	reg_mprj_datal = *(task+9) << 16;
	...
	reg_mprj_datal = *(task+2) << 16;
	reg_mprj_datal = *(task+3) << 16;
	reg_mprj_datal = *(task+4) << 16;
	reg_mprj_datal = *(task+5) << 16;
	reg_mprj_datal = *(task+6) << 16;
	reg_mprj_datal = *(task+7) << 16;
	reg_mprj_datal = *(task+8) << 16;
	reg_mprj_datal = *(task+9) << 16;
